...
// For first-pass figures for Peru, try just a sum of the negative binomial mean over the range of simulated pixels
 ...
 y_sim[n] = (1 - zero) * poisson_log_rng(lambda_log_pred[n]);
